...
# meta banner: https://raw.githubusercontent.com/SkyComic-hash/Banner/main/timeinnick.jpg
# meta name: TimeInNick
# scope: hikka_only
# meta version: 1.0.0
...
TIMEZONE_OFFSETS = {
    "UA": 3,       # Украина (EEST / Летнее время)
    "EEST": 3,     # Восточноевропейское летнее время (Украина)
    "EET": 2,      # Восточноевропейское время (Украина, зимнее)
    "MSK": 3,      # Москва
